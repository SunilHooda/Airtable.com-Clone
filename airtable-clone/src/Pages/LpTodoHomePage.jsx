...
import { LpTaskCard } from "../Components/Todo/LpTaskCard";
import { getTasks } from "../Redux/AppContext/actions";

const LpTodoHomePage = () => {

    const tasks = useSelector((store) => store.AppContext.users.todos);
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <Box>
                        {tasks.length > 0 && 
                        tasks.filter(item => item.task_status === "progress")
                        .filter(filterByParamTags)
                        .map((item) => {
