        ...
        <Box>
                    ...
                    <Box textAlign='left' margin={'auto'} w={'50%'}>
                        ...
                        <Collapse startingHeight={5} in={show1}>
                            <Text cursor="pointer" >Airtable plans are charged per seat. If you are on Airtable’s Free plan, you can add viewers and commenters to your workspace for free. If you are on a paid Airtable plan, you will be charged for all collaborators who have edit or comment permissions to at least one base in the workspace. No charges will apply for read-only collaborators or people submitting forms. Charges are prorated: collaborators with edit permissions added partway through the month will only be charged for the days they were collaborators.</Text>
                            <Divider height={"5"} />
                        </Collapse>
                    </Box>
                    <Box textAlign='left' margin={'auto'} w={'50%'}>
                    ...
                    <Box textAlign='left' margin={'auto'} w={'50%'}>
                        ...
                        <Collapse startingHeight={5} in={show3}>
                            <Text cursor="pointer" >All payments are made via credit card for Plus and Pro workspaces. For Enterprise accounts, we can issue an annual invoice with payment via PO and/or ACH, wire, or check. Please contact sales for more information.</Text>
                            <Divider height={"5"} />
                        </Collapse>
                    </Box>
                    <Box textAlign='left' margin={'auto'} w={'50%'}>
