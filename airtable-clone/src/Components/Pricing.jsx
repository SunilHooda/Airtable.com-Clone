  ...
  return (
    <Box py={12}>
      ...
      <Box>
        ...
        <Box margin={'auto'}   w='100%' display={'flex'} gap={'5'} justifyContent={'center'} className={styles.hidebox} >
          ...
          <Box><Text margin={'3'} fontWeight={'700'} fontSize={'xl'} >Free</Text><Button borderRadius={40} border={'1px solid black'} >Sign up</Button></Box>
          <Box justifyContent={'center'} alignItems={'center'} mt={'8'}>
              ...
              <Box margin={'auto'} textAlign={'center'}><Text margin={'auto'} fontSize={'xl'} mt={'3'}><BsCheckLg /></Text></Box>
              <Box margin={'auto'} textAlign={'center'}><Text margin={'auto'} fontSize={'xl'} mt={'3'}><BsCheckLg /></Text></Box>
              <Box margin={'auto'} textAlign={'center'}><Text margin={'auto'} fontSize={'xl'} mt={'3'}><BsCheckLg /></Text></Box>
              <Box margin={'auto'} textAlign={'center'}><Text margin={'auto'} fontSize={'xl'} mt={'3'}><BsCheckLg /></Text></Box>
            </Box></Box></Box>
          ...
          <Box bg={"#ffeab6"} borderRadius={'10'}  padding={'15px'}  w={'11%'}><Box><Text margin={'3'} fontWeight={'700'} fontSize={'xl'} >Plus</Text><Button borderRadius={40} border={'1px solid black'} >Try for free</Button>
          ...
          <Box padding={'15px'} borderRadius={'10'} bg={'#d0f0fd'} w={'11%'}><Box><Text margin={'3'} fontWeight={'700'} fontSize={'xl'} >Pro</Text><Button bg={'#2d7ff9'} borderRadius={40} >Try for free</Button></Box>
          <Box justifyContent={'center'} alignItems={'center'} mt={'8'}>
              <Text fontSize={'xl'} mt={'2'}>unlimited</Text>
              <Text fontSize={'xl'} mt={'3'}>unlimited</Text>
          ...
          <Box padding={'15px'} borderRadius={'10'} bg={'#333333'} color={'white'} w={'11%'}><Box><Text margin={'3'} fontWeight={'700'} fontSize={'xl'} >Enterprize</Text><Button borderRadius={40} border={'1px solid black'} color='black' >Contact sales</Button></Box>
          <Box justifyContent={'center'} alignItems={'center'} mt={'8'}>
              <Text fontSize={'xl'} mt={'2'}>unlimited</Text>
              <Text fontSize={'xl'} mt={'3'}>unlimited</Text>
            ...
            <Box mt={'10'}>
              <Heading>Have additional questions?</Heading>
