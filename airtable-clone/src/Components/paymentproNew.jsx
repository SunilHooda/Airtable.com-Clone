...
const PaymentPro = () => {
  return (
    <Container maxWidth={"5xl"}>
      <div
        className="row"
        style={{ display: "flex", padding: "50px", justifyContent: "center" }}
      >
        <div className="col"></div>
        <Box
          display={{ "2xl": "flex", xl: "flex" }}
        ...
        >
          ...
          <Container maxWidth={"sm"}>
            <Box bg={"#d0f0fd"} borderRadius={"15"} m={"auto"} mt={"15px"}>
              ...
              <img
                src="https://static.airtable.com/images/pricing/pro-checkout-banner-background-lower-highlight.png"
                alt="photo"
              />
            </Box>
          </Container>
    ...
    <Box justifyContent={"left"}>
      ...
      <Box textAlign={"left"} width={"350px"}>
        <Text
          ...
          fontWeight={"500"}
        >
          You’ve selected the Pro plan for My First Workspace, billed Annually
          at $240 per user per year.
        </Text>
      </Box>
      <Box
        display={"flex"}
